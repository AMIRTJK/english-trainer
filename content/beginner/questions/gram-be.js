...
const P92 = { book: 'SB', page: 92, ref: 'Grammar Bank 1A / 1B' };
const P94 = { book: 'SB', page: 94, ref: 'Grammar Bank 2A / 2B' };
const singularDrafts = [
...
export const gramBeSingularIYou = makeQuestions(cfg('beg-g-be-sing-i-you', 1, 'iy', P92), singularDrafts.slice(0, 8));
export const gramBeSingularHeShe = makeQuestions(cfg('beg-g-be-sing-he-she-it', 1, 'hs', P92), singularDrafts.slice(8));
export const gramBePlural = makeQuestions(cfg('beg-g-be-plural', 2, 'pl', P94), pluralDrafts);
export const gramWhQuestionsBe = makeQuestions(cfg('beg-g-wh-questions-be', 2, 'wh', P94), whDrafts);
