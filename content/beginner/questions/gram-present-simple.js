...
const P100 = { book: 'SB', page: 100, ref: 'Grammar Bank 5A / 5B' };
const P102 = { book: 'SB', page: 102, ref: 'Grammar Bank 6A / 6B' };
const posNegDrafts = [
...
export const gramPresentSimplePosNeg = makeQuestions(cfg('beg-g-present-simple-pos-neg', 5, 'ps', P100), posNegDrafts.slice(0, 8));
export const gramPresentSimpleQuestions = makeQuestions(cfg('beg-g-present-simple-questions', 5, 'pq', P100), posNegDrafts.slice(8));
export const gramPresentSimpleHeShe = makeQuestions(cfg('beg-g-present-simple-he-she-it', 6, 'p3', P102), heSheItDrafts);
export const gramAdverbsFrequency = makeQuestions(cfg('beg-g-adverbs-frequency', 6, 'af', P102), frequencyDrafts);
