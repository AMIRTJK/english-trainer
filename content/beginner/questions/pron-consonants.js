...
const SRC = { book: 'SB', page: 135, ref: 'Sound Bank — consonant sounds' };
const rows = [
...
const drafts = rows.map(([words, answer, oddLabel, otherLabel, ipa]) => {
...
export const pronConsonants = makeQuestions({
