...
export const vocabClassroom = makeQuestions(cfg('beg-v-classroom', 1, 'cl', 118, 'Vocabulary Bank — The classroom'), classroomDrafts);
export const vocabSmallThings = makeQuestions(cfg('beg-v-small-things', 3, 'st', 119, 'Vocabulary Bank — Small things'), smallThingsDrafts);
export const vocabFamily = makeQuestions(cfg('beg-v-people-family', 4, 'fa', 120, 'Vocabulary Bank — People and family'), familyDrafts);
export const vocabFood = makeQuestions(cfg('beg-v-food-drink', 5, 'fo', 122, 'Vocabulary Bank — Food and drink'), foodDrafts);
export const vocabColours = makeQuestions(cfg('beg-v-colours-adjectives', 4, 'co', 121, 'Vocabulary Bank — Adjectives'), colourDrafts);
