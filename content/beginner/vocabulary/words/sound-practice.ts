...
const groups: WordGroup[] = [
  {
    ...
    rows: [
      ...
      ['they', 'они', 'train', '/ðeɪ/'],
      ['I', 'я', 'bike', '/aɪ/'],
      ['euro', 'евро', 'tourist', '/ˈjʊərəʊ/'],
      ['Europe', 'Европа', 'tourist', '/ˈjʊərəp/'],
      ['plural', 'множественное число', 'tourist', '/ˈplʊərəl/'],
      ['situation', 'ситуация', 'train', '/ˌsɪtʃuˈeɪʃn/'],
      ['education', 'образование', 'train', '/ˌedʒuˈkeɪʃn/'],
    ],
  },
  {
